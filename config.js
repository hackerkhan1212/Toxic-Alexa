...
module.exports = {
    ...
    AFN: process.env.ALL_CAPTION === undefined ? 'Made By Itx_Ibrahim-Bot' : process.env.ALL_CAPTION,
    ...
    OWNER: process.env.OWNER_NAME === undefined ? '𝕴𝖙𝖝_𝖎𝖇𝖗𝖆𝖍𝖎𝖒' : process.env.OWNER_NAME,
    PHONE: process.env.NUMBER === undefined ? '923229931076' : process.env.NUMBER,
    MENTION: process.env.TAG_REPLY === undefined ? '9232299310762@s.whatsapp.net' : process.env.TAG_REPLY,
    ...
    BC: process.env.BROADCAST_NAME === undefined ? '🥵Itx_Ibrahim-Bot🥶⁩' : process.env.BROADCAST_NAME,
    BOTSK: process.env.BOT_NAME === undefined ? '🥵Itx_Ibrahim-Bot🥶' : process.env.BOT_NAME,
    ...
    TURBO: process.env.NAME_STYLE === undefined ? 'Itx_ibrahim' : process.env.NAME_STYLE,
    INSTA: process.env.INSTA_LINK === undefined ? 'https://www.instagram.com/its_ibrahim_2004/' : process.env.INSTA_LINK,
    GROUP: process.env.GROUP_LINK === undefined ? 'https://wa.me/923229931076?text=_៚ʜᴇʟʟᴏ+𝕚𝕥𝕩_𝕚𝕓𝕣𝕒𝕙𝕚𝕞+ʙɪɢ+ғᴀɴ+ᴠʀᴏ+🪄_' : process.env.GROUP_LINK,
    LOGOSK: process.env.ALL_IMG === undefined ? 'https://telegra.ph/file/ca0041472c493c13eda75.jpg' : process.env.ALL_IMG,
    SLINK: process.env.SOCIAL_MEDIA === undefined ? 'https://www.instagram.com/its_ibrahim_2004/' : process.env.SOCIAL_MEDIA,
    ...
    SUDO: process.env.SUDO === undefined ? '923229931076,0' : process.env.SUDO,
    DEBUG: DEBUG,
